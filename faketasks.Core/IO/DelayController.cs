...
public sealed class DelayController
{
    ...
    private int _linesPrintedInstantly;
    ...
    /// </summary>
    private TimeSpan ScaleDelay(TimeSpan baseDuration)
    {
        ...
        var scaledMilliseconds = baseDuration.TotalMilliseconds / _config.SpeedFactor;
